...
# Created by Eugene Davies @ 20 March 2020
import openpyxl

wb = openpyxl.load_workbook("ChangeRequestv2.xlsx")
...
if soShared == "y":
    changeSheet["B8"] = "Yes"
    changeSheet["C8"] = get_resource("SO Shared Hosting", 8, 8, 2, 7)
else:
    changeSheet["B8"] = "No"
...
if soRetail == "y":
    changeSheet["B9"] = "Yes"
    changeSheet["C9"] = get_resource("SO Retail Hosting", 9, 9, 2, 10)
else:
    changeSheet["B9"] = "No"
...
if soCCG == "y":
    changeSheet["B10"] = "Yes"
    changeSheet["C10"] = get_resource("SO Retail Hosting", 10, 10, 2, 12)
else:
    changeSheet["B10"] = "No"
...
if wintel == "y":
    changeSheet["B11"] = "Yes"
    changeSheet["C11"] = get_resource("SO Retail Hosting", 11, 11, 2, 10)
else:
    changeSheet["B11"] = "No"
...
if soKZN == "y":
    changeSheet["B12"] = "Yes"
    changeSheet["C12"] = get_resource("SO Retail Hosting", 12, 12, 2, 10)
else:
    changeSheet["B12"] = "No"
...
if f5 == "y":
    changeSheet["B13"] = "Yes"
    changeSheet["C13"] = get_resource("SO Retail Hosting", 13, 13, 2, 10)
else:
    changeSheet["B13"] = "No"
...
if sqlSupport == "y":
    changeSheet["B14"] = "Yes"
    changeSheet["C14"] = get_resource("SO Retail Hosting", 14, 14, 2, 12)
else:
    changeSheet["B14"] = "No"
...
if dnsSO == "y":
    changeSheet["B15"] = "Yes"
    changeSheet["C15"] = get_resource("SO Retail Hosting", 15, 15, 2, 10)
else:
    changeSheet["B15"] = "No"
...
if firewall == "y":
    changeSheet["B16"] = "Yes"
    changeSheet["C16"] = get_resource("SO Retail Hosting", 16, 16, 2, 7)
else:
    changeSheet["B16"] = "No"
...
if tsm == "y":
    changeSheet["B17"] = "Yes"
    changeSheet["C17"] = get_resource("SO Retail Hosting", 17, 17, 2, 7)
else:
    changeSheet["B17"] = "No"
...
if aix == "y":
    changeSheet["B18"] = "Yes"
    changeSheet["C18"] = get_resource("SO Retail Hosting", 18, 18, 2, 7)
else:
    changeSheet["B18"] = "No"

miss = input("MISS (Y/N): ").lower()
while miss != "y" and miss != "n":
    miss = input("MISS (Y/N): ").lower()
if miss == "y":
    changeSheet["B19"] = "Yes"
    changeSheet["C19"] = get_resource("SO Retail Hosting", 19, 19, 2, 12)
else:
    changeSheet["B19"] = "No"

ciss = input("CISS (Y/N): ").lower()
while ciss != "y" and ciss != "n":
    ciss = input("CISS (Y/N): ").lower()
if ciss == "y":
    changeSheet["B20"] = "Yes"
    changeSheet["C20"] = get_resource("SO Retail Hosting", 20, 20, 2, 12)
else:
    changeSheet["B20"] = "No"
...
if proxyemail == "y":
    changeSheet["B21"] = "Yes"
    changeSheet["C21"] = get_resource("SO Retail Hosting", 21, 21, 2, 10)
else:
    changeSheet["B21"] = "No"
...
if datapower == "y":
    changeSheet["B22"] = "Yes"
    changeSheet["C22"] = get_resource("SO Retail Hosting", 22, 22, 2, 10)
else:
    changeSheet["B22"] = "No"
